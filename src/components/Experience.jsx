    ...
    return [
      {
        ...
        subtitle: `Hello passengers and welcome aboard. Please sit back, relax and enjoy the view while we tell you some of our favourite facts about the aviation world`,
      },
      {
        cameraRailDist: 1.5,
        position: new THREE.Vector3(
        ...
        title: "MAYDAY MAYDAY",
        subtitle: `"MAYDAY" was made official as an international distress call in 1948. It is derived from the French word "m'aidez", which means "help me"!`,
      },
      {
        cameraRailDist: -1,
        position: new THREE.Vector3(
        ...
        title: "A LONG FLIGHT",
        subtitle: `The longest commercial flight you can book is a flight from Singapore to New York that lasts 18 hours 50 minutes...better get comfortable!`,
      },
      {
        cameraRailDist: 1.5,
        position: new THREE.Vector3(
        ...
        subtitle: `Since the number 13 is considered an unlucky number in Western culture, most airlines don't have a row 13 on their planes!`,
      },
    ];
  }, []);
